...
// Main function to drive the program
        ...
        cout << "3. Food Management System2\n";
...

        {
            ...
            // Adding Mumbai locations and their connections

            graph.addEdge("Marine Drive", "Gateway of India", 2);


            graph.addEdge("Marine Drive", "Churchgate Station", 1);


            graph.addEdge("Churchgate Station", "CST Station", 2);

            graph.addEdge("CST Station", "Bandra Station", 10);

            graph.addEdge("Bandra Station", "Juhu Beach", 6);

            graph.addEdge("Juhu Beach", "Andheri Station", 7);


            graph.addEdge("Andheri Station", "Versova Beach", 5);

            graph.addEdge("Versova Beach", "Bandra-Worli Sea Link", 4);

            graph.addEdge("Bandra-Worli Sea Link", "Worli Sea Face", 3);

            graph.addEdge("Worli Sea Face", "Lower Parel", 5);

            graph.addEdge("Lower Parel", "Dadar Station", 4);

            graph.addEdge("Dadar Station", "Kandivali Station", 10);


            graph.addEdge("Kandivali Station", "Goregaon Station", 6);

            graph.addEdge("Goregaon Station", "Powai", 8);



            graph.bfs("Marine Drive");

            graph.dfs("Marine Drive");
...

{
...

            {
                ...
                cout << "Food Management System2 Menu:\n";
